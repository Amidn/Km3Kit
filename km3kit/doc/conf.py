...
try:
    ...
    version = get_version('km3kit')
except ImportError:
    from pkg_resources import get_distribution
    version = get_distribution('km3kit').version

# -- Project information -----------------------------------------------------
short_version = '.'.join(version.split('.')[:2])
project = 'km3kit {}'.format(short_version)
copyright = '{0}, Amid Nayerhoda'.format(date.today().year)
...
html_title = "km3kit {}".format(version)
